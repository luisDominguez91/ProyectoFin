...
public enum PeriodFrequencyType {
    ...
    FT_AND_END_OF_MONTH(6, "periodFrequencyType.ft_and_end_of_month");
    ...
    public boolean isFTAndEndOfMonth() {
        return this.value.equals(PeriodFrequencyType.FT_AND_END_OF_MONTH.getValue());
    } 
