...
public class SearchReadPlatformServiceImpl implements SearchReadPlatformService {
    ...
    private static final class SearchMapper implements RowMapper<SearchData> {
        ...
        public String searchSchema(final SearchConditions searchConditions) {
            ...
            final String clientMatchSql = " (select 'CLIENT' as entityType, c.id as entityId, c.display_name as entityName, c.ctm_curp as entityExternalId, c.account_no as entityAccountNo "
                    ...
                    + " from m_client c join m_office o on o.id = c.office_id where o.hierarchy like :hierarchy and (c.account_no like :search or c.display_name like :search or c.ctm_curp like :search or c.mobile_no like :search)) ";
