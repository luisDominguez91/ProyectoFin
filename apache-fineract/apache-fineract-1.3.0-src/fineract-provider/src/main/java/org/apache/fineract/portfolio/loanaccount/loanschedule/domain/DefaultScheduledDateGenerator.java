...
public class DefaultScheduledDateGenerator implements ScheduledDateGenerator {
    private final static Logger logger = LoggerFactory.getLogger(DefaultScheduledDateGenerator.class);
    ...
    public LocalDate getLastRepaymentDate(final LoanApplicationTerms loanApplicationTerms, final HolidayDetailDTO holidayDetailDTO) {
        ...
        logger.info("SGV getLastRepaymentDate.numberOfRepayments:" + numberOfRepayments);

        LocalDate lastRepaymentDate = loanApplicationTerms.getExpectedDisbursementDate();

        logger.info("SGV getLastRepaymentDate.loanApplicationTerms.getExpectedDisbursementDate():" + lastRepaymentDate);
        ...
        logger.info("SGV getLastRepaymentDate.lastRepaymentDate" + lastRepaymentDate);
    ...
    public LocalDate generateNextRepaymentDate(final LocalDate lastRepaymentDate, final LoanApplicationTerms loanApplicationTerms,
        ...
        logger.info("SGV generateNextRepaymentDate.firstRepaymentPeriodDate:" + firstRepaymentPeriodDate);

        LocalDate dueRepaymentPeriodDate = null;
        if (isFirstRepayment && firstRepaymentPeriodDate != null) {
            logger.info("SGV isFirstRepayment && firstRepaymentPeriodDate != null");
            ...
            logger.info("SGV generateNextRepaymentDate.getRepaymentPeriodDate(...):" + dueRepaymentPeriodDate);
            ...
            logger.info("SGV generateNextRepaymentDate.adjustDate(...):" + dueRepaymentPeriodDate);
    ...
    public LocalDate getRepaymentPeriodDate(final PeriodFrequencyType frequency, final int repaidEvery, final LocalDate startDate) {
        ...
        switch (frequency) {
            ...
            case FT_AND_END_OF_MONTH:
                dueRepaymentPeriodDate = Quincena.sumarQuincenas(startDate,repaidEvery);
            break;
            case INVALID:
            break;
        }
    ...
    public LocalDate idealDisbursementDateBasedOnFirstRepaymentDate(final PeriodFrequencyType repaymentPeriodFrequencyType,
        ...
        switch (repaymentPeriodFrequencyType) {
            ...
            break;
            case FT_AND_END_OF_MONTH:
                idealDisbursementDate = Quincena.restarQuincenas(firstRepaymentDate,repaidEvery);
            break;
            case INVALID:
            break;
        }
