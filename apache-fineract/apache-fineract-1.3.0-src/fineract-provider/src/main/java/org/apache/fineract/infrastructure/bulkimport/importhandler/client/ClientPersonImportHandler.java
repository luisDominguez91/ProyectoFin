...
public class ClientPersonImportHandler implements ImportHandler {
   ...
   @Autowired
    ...
    private ClientData readClient(Row row,final String locale, final String dateFormat) {
        ...
        String motherlastName = ImportHandlerUtils.readAsString(ClientPersonConstants.MOTHERLAST_NAME_COL, row);
        ...
        return ClientData.importClientPersonInstance(legalFormId,row.getRowNum(),firstName,lastName,motherlastName,middleName,submittedOn,activationDate,active,externalId,
    ...
    public Count importEntity(String dateFormat) {
        ...
        for (ClientData client: clients) {
            try {
                ...
                Cell clientIdCell = clientSheet.getRow(client.getRowIndex()).createCell(ClientPersonConstants.CLIENT_ID);
                clientIdCell.setCellValue( commandRequest.getJson());
