...
public class ClientPersonWorkbookPopulator extends AbstractWorkbookPopulator {
  ...
  private void setLayout(Sheet worksheet) {
    ...
    worksheet.setColumnWidth(ClientPersonConstants.MOTHERLAST_NAME_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
    writeString(ClientPersonConstants.FIRST_NAME_COL, rowHeader, "Nombre*");
    writeString(ClientPersonConstants.LAST_NAME_COL, rowHeader, "Apellido Paterno*");
    //writeString(ClientPersonConstants.MIDDLE_NAME_COL, rowHeader, "Middle Name");
    writeString(ClientPersonConstants.MOTHERLAST_NAME_COL, rowHeader, "Apellido Materno");
