...
final class ClientAddressApiResourcesSwagger {
    ...
    @ApiModel(value = "DeleteClientClientIdAddressesRequest")
    public final static class DeleteClientClientIdAddressesRequest {
        private DeleteClientClientIdAddressesRequest() {
        }
    }

    @ApiModel(value = "DeleteClientClientIdAddressesResponse")
    public final static class DeleteClientClientIdAddressesResponse {
        private DeleteClientClientIdAddressesResponse() {
        }
