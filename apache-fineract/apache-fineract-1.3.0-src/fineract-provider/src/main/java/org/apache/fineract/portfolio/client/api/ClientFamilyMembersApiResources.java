...
public class ClientFamilyMembersApiResources 
{
	...
	public String getFamilyMember(@Context final UriInfo uriInfo,@PathParam("familyMemberId") final Long familyMemberId) {
		...
		ClientFamilyMembersData familyMembers =this.readPlatformService.getClientFamilyMember(familyMemberId);

		final ClientFamilyMembersData options = this.readPlatformService.retrieveTemplate();

		familyMembers.setGenderIdOptions(options.getGenderIdOptions());
		familyMembers.setMaritalStatusIdOptions(options.getMaritalStatusIdOptions());
		familyMembers.setProfessionIdOptions(options.getProfessionIdOptions());
		familyMembers.setRelationshipIdOptions(options.getRelationshipIdOptions());
