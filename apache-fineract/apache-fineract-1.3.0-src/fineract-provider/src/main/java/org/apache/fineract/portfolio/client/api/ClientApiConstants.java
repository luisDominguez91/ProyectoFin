...
public class ClientApiConstants {
    ...
    // Se agregan code nuevo{
    public static final String FILIATION = "Filiation";
    ...
    public static final String sonsNoParamName = "sonsNo";
    public static final String nssParamName = "nss";
    public static final String phoneNoParamName = "phoneNo";
    public static final String filiationIdParamName = "filiationId";
    public static final String migrationIdParamName = "migrationId";
    // }
    ...
    public static final String addressTypeIdParamName = "addressTypeId";
    public static final String streetParamName = "street";
    public static final String betweenStreetsParamName= "betweenStreets";
    public static final String extNoParamName= "extNo";
    public static final String intNoParamName= "intNo";
    public static final String addressLine1ParamName= "addressLine1";
    public static final String buildingParamName= "building";
    public static final String departmentParamName= "department";
    public static final String addressLine2ParamName= "addressLine2";
    public static final String lotParamName= "lot";
    public static final String blockParamName= "block";
    public static final String addressLine3ParamName= "addressLine3";
    public static final String postalCodeParamName= "postalCode";
    public static final String suburbIdParamName= "suburbId";
    public static final String townVillageParamName= "townVillage";
    public static final String cityIdParamName= "cityId";
    public static final String cityParamName= "city";
    public static final String municipalityIdParamName= "municipalityId";
    public static final String countyDistrictParamName= "countyDistrict";
    ...
    public static final String addressLimit = "addressLimit";
    // }

    // Constantes para el familiar {
    ...
    public static final String qualificationParamName = "qualification";
    ...
    // Contantas para el pais en la dirección

    public static final String countryNameParamValue = "México";
    public static final Long countryIdParamValue = new Long("0");
}