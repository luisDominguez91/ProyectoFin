...
public class ExpedienteData {
    ...
    private final Long conyuge;
    private final Long estado;
    private final String modalidad;
    private final String credito;
    private final String tipoCredito;
    private final Long fase;

    public ExpedienteData(Long titular, Long conyuge, Long estado, String modalidad, String credito,
            String tipoCredito, Long fase) {
