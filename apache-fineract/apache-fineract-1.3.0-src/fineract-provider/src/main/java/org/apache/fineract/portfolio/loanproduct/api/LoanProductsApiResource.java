...
public class LoanProductsApiResource {
    ...
    public String retrieveTemplate(@Context final UriInfo uriInfo, @QueryParam("isProductMixTemplate") @ApiParam(value = "isProductMixTemplate") final boolean isProductMixTemplate) {
        ...
        LoanProductData loanProduct = this.loanProductReadPlatformService.retrieveNewLoanProductDetails();//System.out.println("va 1: " + this.toApiJsonSerializer.serialize(settings, loanProduct, this.LOAN_PRODUCT_DATA_PARAMETERS));
        loanProduct = handleTemplate(loanProduct);//System.out.println("va 2: " + this.toApiJsonSerializer.serialize(settings, loanProduct, this.LOAN_PRODUCT_DATA_PARAMETERS));
