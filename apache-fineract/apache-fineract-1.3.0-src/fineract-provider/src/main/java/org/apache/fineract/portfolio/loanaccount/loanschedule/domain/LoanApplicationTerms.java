...
import org.apache.fineract.infrastructure.util.Quincena;
...
public final class LoanApplicationTerms {
    ...
    public PrincipalInterest calculateTotalInterestForPeriod(final PaymentPeriodsInOneYearCalculator calculator,
        ...
        logger.info("SGV calculateTotalInterestForPeriod{");
        Money interestForInstallment = this.principal.zero();
        logger.info("SGV interestForInstallment:" + interestForInstallment.getAmount());
        ...
        logger.info("SGV totalInterestDue:" + totalInterestDue.getAmount());
        ...
        switch (interestMethod) {
            ...
            break;
            case DECLINING_BALANCE:
                logger.info("SGV DECLINING_BALANCE");
                ...
                logger.info("SGV interestForThisInstallmentBeforeGrace:" + interestForThisInstallmentBeforeGrace.getAmount());
                ...
                logger.info("SGV interestForThisInstallmentAfterGrace:" + interestForThisInstallmentAfterGrace.getAmount());
        ...
        logger.info("SGV interestForInstallment:" + interestForInstallment.getAmount());
        logger.info("SGV interestBroughtForwardDueToGrace:" + interestBroughtForwardDueToGrace.getAmount());
    ...
    public BigDecimal calculatePeriodsBetweenDates(final LocalDate startDate, final LocalDate endDate) {
        ...
        switch (this.repaymentPeriodFrequencyType) {
            ...
            break;
            case FT_AND_END_OF_MONTH:
                logger.info("SGV calculatePeriodsBetweenDates.FT_AND_END_OF_MONTH");
                numberOfPeriods = new BigDecimal(Quincena.quincenasEntre(startDate,endDate));
                break;
            default:
            break;
        }
    ...
    private BigDecimal periodicInterestRate(final PaymentPeriodsInOneYearCalculator calculator, final MathContext mc, final DaysInMonthType daysInMonthType,
        ...
        logger.info("SGV periodicInterestRate{");
        final long loanTermPeriodsInOneYear = calculatePeriodsInOneYear(calculator);
        logger.info("SGV periodicInterestRate.loanTermPeriodsInOneYear:" + loanTermPeriodsInOneYear);
        final BigDecimal divisor = BigDecimal.valueOf(Double.valueOf("100.0"));
        final BigDecimal loanTermPeriodsInYearBigDecimal = BigDecimal.valueOf(loanTermPeriodsInOneYear);
        ...
        switch (this.interestCalculationPeriodMethod) {
            ...
            break;
            case SAME_AS_REPAYMENT_PERIOD:
                logger.info("SGV SAME_AS_REPAYMENT_PERIOD");
                logger.info("SGV periodicInterestRate.annualNominalInterestRate:" + annualNominalInterestRate);
                logger.info("SGV periodicInterestRate.loanTermPeriodsInYearBigDecimal:" + loanTermPeriodsInYearBigDecimal);
                logger.info("SGV periodicInterestRate.divisor:" + divisor);
                logger.info("SGV periodicInterestRate.loanTermFrequencyBigDecimal:" + loanTermFrequencyBigDecimal);
...
//        numPeriods = numPeriods - this.periodsCompleted;
    ...
    private Money calculateDecliningInterestDueForInstallmentBeforeApplyingGrace(final PaymentPeriodsInOneYearCalculator calculator,
        ...
        logger.info("SGV calculateDeclin{ingInterestDueForInstallmentBeforeApplyingGrace ");
        ...
        final BigDecimal periodicInterestRate = periodicInterestRate(calculator, mc, this.daysInMonthType, this.daysInYearType,
                periodStartDate, periodEndDate);
        logger.info("SGV AbstractLoanScheduleGenerator.periodicInterestRate: " + periodicInterestRate);
        interestDue = outstandingBalance.multiplyRetainScale(periodicInterestRate, mc.getRoundingMode());
        logger.info("SGV AbstractLoanScheduleGenerator.interestDue: " + interestDue);
        return interestDue;
    }
