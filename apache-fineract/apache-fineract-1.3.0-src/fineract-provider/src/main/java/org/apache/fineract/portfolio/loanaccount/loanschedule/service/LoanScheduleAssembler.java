...
public class LoanScheduleAssembler {
    ...
    private LocalDate deriveFirstRepaymentDate(final AccountType loanType, final Integer repaymentEvery,
        ...
        logger.info("SGV deriveFirstRepaymentDate{");
        ...
        if (calendar != null) {
            ...
            if (repaymentPeriodFrequencyType.isDaily()) {
                ...
                logger.info("SGV expectedDisbursementDate:" + expectedDisbursementDate);
                dateBasedOnRepaymentFrequency=Quincena.sumarQuincenas(expectedDisbursementDate,repaymentEvery);
                logger.info("SGV dateBasedOnRepaymentFrequency:" + dateBasedOnRepaymentFrequency);
            }
