...
public class DefaultPaymentPeriodsInOneYearCalculator implements PaymentPeriodsInOneYearCalculator {
    private final static Logger logger = LoggerFactory.getLogger(DefaultPaymentPeriodsInOneYearCalculator.class);
    ...
    public double calculatePortionOfRepaymentPeriodInterestChargingGrace(final LocalDate repaymentPeriodStartDate,
        ...
        logger.info("SGV calculatePortionOfRepaymentPeriodInterestChargingGrace.repaymentPeriodStartDate: " + repaymentPeriodStartDate);
        logger.info("SGV calculatePortionOfRepaymentPeriodInterestChargingGrace.scheduledDueDate: " + scheduledDueDate);
        ...
        if (interestChargedFromLocalDate != null && repaymentPeriod.fallsBefore(interestChargedFromLocalDate.plusDays(1))) {
            ...
            logger.info("SGV interestChargedFromLocalDate != null && repaymentPeriod.contains(interestChargedFromLocalDate)");
        ...
        logger.info("SGV calculatePortionOfRepaymentPeriodInterestChargingGrace.periodFraction:" + periodFraction);
    ...
    private double calculateRepaymentPeriodFraction(final PeriodFrequencyType repaymentPeriodFrequencyType, final Integer every,
        ...
        switch (repaymentPeriodFrequencyType) {
            ...
            break;
            case FT_AND_END_OF_MONTH:
                fraction = numberOfDaysInterestCalculationGrace.doubleValue() / (Double.valueOf("15.0") * every.doubleValue());
            break;
            case MONTHS:
