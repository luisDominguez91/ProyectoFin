...
public class ClientWritePlatformServiceJpaRepositoryImpl implements ClientWritePlatformService {
    ...
    private void handleDataIntegrityIssues(final JsonCommand command, final Throwable realCause, final Exception dve) {
        ...
        /* Se deshabilita la validación del número telefonico duplicado
    ...
    public CommandProcessingResult createClient(final JsonCommand command) {
        ...
        try {
            ...
            // Se agregan campos de tipo Code {
            ...
            if (maritalStatusId != null) {
                maritalStatus = this.codeValueRepository.findOneByCodeNameAndIdWithNotFoundDetection(ClientApiConstants.MARITALSTATUS, maritalStatusId);
            }
            CodeValue filitation = null;
            final Long filitationId = command.longValueOfParameterNamed(ClientApiConstants.filiationIdParamName);
            if (filitationId != null) {
                filitation = this.codeValueRepository.findOneByCodeNameAndIdWithNotFoundDetection(ClientApiConstants.FILIATION, filitationId);
            }
            // }
            ...
            if (command.arrayOfParameterNamed(ClientApiConstants.familyMembers) != null) {
            ...
            return new CommandProcessingResultBuilder() //
                    ...
                    .withMigrationId(newClient.getMigrationId())//
                    .withGroupId(groupId) //
    ...
    public CommandProcessingResult updateClient(final Long clientId, final JsonCommand command) {
        ...
        try {
            ...
            final Map<String, Object> changes = clientForUpdate.update(command,user);
            ...
            // Se agregan los campos de tipo CodeValue {
            if (changes.containsKey(ClientApiConstants.maritalStatusIdParamName)) {
                ...
                CodeValue maritalStatus = null;
                if (newValue != null) {
                    maritalStatus = this.codeValueRepository.findOneByCodeNameAndIdWithNotFoundDetection(ClientApiConstants.MARITALSTATUS, newValue);
                }
                clientForUpdate.updateMaritalStatus(maritalStatus);
            }
            if (changes.containsKey(ClientApiConstants.filiationIdParamName)) {

                final Long newValue = command.longValueOfParameterNamed(ClientApiConstants.filiationIdParamName);
                CodeValue filiation = null;
                if (newValue != null) {
                    filiation = this.codeValueRepository.findOneByCodeNameAndIdWithNotFoundDetection(ClientApiConstants.FILIATION, newValue);
                }
                clientForUpdate.updateFiliation(filiation);
            }
            // }
