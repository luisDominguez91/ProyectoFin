...
final public class ClientData implements Comparable<ClientData> {
    ...
    private final String sonsNo;
    private final String nss;
    private final CodeValueData filiation;
    ...
    private final Collection<CodeValueData> filiationOptions;
    ...
    public static ClientData importClientEntityInstance(Long legalFormId,Integer rowIndex,String fullname,Long officeId, Long clientTypeId,
        ...
        return  new ClientData(legalFormId,rowIndex,fullname, null,null, null, null, submittedOnDate,activationDate,active, externalId,
        		officeId, staffId,mobileNo,dateOfBirth,clientTypeId, null,clientClassificationId,null, null, null, null, null, null, null, null,
                address,clientNonPersonDetails, locale,dateFormat);
    }

    public static ClientData importClientPersonInstance(Long legalFormId,Integer rowIndex,String firstName,String lastName,String motherlastName,String middleName,
            ...
            Long clientClassificationId, Boolean isStaff, String curp, String rfc, CodeValueData maritalStatus, String sonsNo,
            String nss, CodeValueData filiation, String phoneNo, Collection<AddressData> address,String locale,String dateFormat){

        return new ClientData(legalFormId,rowIndex, null, firstName,lastName,motherlastName,middleName,submittedOn,activationDate,active,externalId,
                officeId,staffId,mobileNo,dob,clientTypeId,genderId,clientClassificationId,isStaff,curp, rfc, maritalStatus, sonsNo, nss, filiation, phoneNo ,address, null, locale,dateFormat);
    }
    ...
    private ClientData(Long legalFormId,Integer rowIndex, String fullname, String firstname,String lastname,String motherlastname,String middlename,
            LocalDate submittedOn,LocalDate activationDate,Boolean active,String externalId,Long officeId,
            Long staffId,String mobileNo, LocalDate dob,Long clientTypeId,Long genderId,
            Long clientClassificationId,Boolean isStaff, final String curp,final String rfc, final CodeValueData maritalStatus, final String sonsNo,
            final String nss, final CodeValueData filiation, final String phoneNo, Collection<AddressData> address, ClientNonPersonData clientNonPersonDetails,
    ...
    public static ClientData template(final Long officeId, final LocalDate joinedDate, final Collection<OfficeData> officeOptions,
            ...
            final Collection<CodeValueData> genderOptions, final Collection<CodeValueData> filiationOptions, final Collection<SavingsProductData> savingProductOptions,
        ...
        final CodeValueData maritalStatus = null;
        final String sonsNo = null;
        final String nss = null;
        final CodeValueData filiation = null;
        ...
        return new ClientData(accountNo, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id, firstname,
                middlename, lastname,motherlastname, fullname, displayName, externalId, mobileNo, emailAddress, dateOfBirth, gender, joinedDate, imageId, staffId,
                staffName, officeOptions, groups, staffOptions, narrations, genderOptions, filiationOptions, timeline, savingProductOptions,
                ...
                curp, rfc, maritalStatus, sonsNo, nss, filiation, phoneNo);
    ...
    public static ClientData templateOnTop(final ClientData clientData, final ClientData templateData) {
        ...
        return new ClientData(clientData.accountNo, clientData.status, clientData.subStatus, clientData.officeId, clientData.officeName,
                ...
                clientData.lastname,clientData.motherlastname, clientData.fullname, clientData.displayName, clientData.externalId, clientData.mobileNo, clientData.emailAddress,
                ...
                templateData.genderOptions, templateData.filiationOptions, clientData.timeline, templateData.savingProductOptions, clientData.savingsProductId,
                ...
                clientData.curp, clientData.rfc, clientData.maritalStatus, clientData.sonsNo, clientData.nss, clientData.filiation, clientData.phoneNo);
    ...
    public static ClientData templateWithSavingAccountOptions(final ClientData clientData,
        ...
        return new ClientData(clientData.accountNo, clientData.status, clientData.subStatus, clientData.officeId, clientData.officeName,
                ...
                clientData.genderOptions, clientData.filiationOptions, clientData.timeline, clientData.savingProductOptions, clientData.savingsProductId,
    ...
    public static ClientData setParentGroups(final ClientData clientData, final Collection<GroupGeneralData> parentGroups) {
        return new ClientData(clientData.accountNo, clientData.status, clientData.subStatus, clientData.officeId, clientData.officeName,
                ...
                clientData.lastname, clientData.motherlastname, clientData.fullname, clientData.displayName, clientData.externalId, clientData.mobileNo, clientData.emailAddress,
                clientData.dateOfBirth, clientData.gender, clientData.activationDate, clientData.imageId, clientData.staffId,
                clientData.staffName, clientData.officeOptions, parentGroups, clientData.staffOptions, null, null,null, clientData.timeline,
				...
				clientData.isAddressEnabled, null, clientData.isStaff,clientData.curp, clientData.rfc, clientData.maritalStatus, clientData.sonsNo,
                clientData.nss, clientData.filiation, clientData.phoneNo);
    ...
    public static ClientData clientIdentifier(final Long id, final String accountNo, final String firstname, final String middlename,
            final String lastname, final String motherlastname, final String fullname, final String displayName, final Long officeId, final String officeName) {
        ...
        final Collection<CodeValueData> filiationOptions = null;
        final ClientTimelineData timeline = null;
        ...
        final String phoneNo = null;
        return new ClientData(accountNo, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id, firstname,
                middlename, lastname, motherlastname, fullname, displayName, externalId, mobileNo, emailAddress, dateOfBirth, gender, activationDate, imageId, staffId,
                staffName, allowedOffices, groups, staffOptions, closureReasons, genderOptions, filiationOptions, timeline, savingProductOptions,
                savingsProductId, savingsProductName, savingsAccountId, savingAccountOptions, clientType, clientClassification,
                clientTypeOptions, clientClassificationOptions, clientNonPersonConstitutionOptions, clientNonPersonMainBusinessLineOptions,
    ...
    public static ClientData instance(final String accountNo, final EnumOptionData status, final CodeValueData subStatus,
            ...
            final String firstname, final String middlename, final String lastname, final String motherlastname, final String fullname, final String displayName,
            ...
            final String curp,final String rfc, final CodeValueData maritalStatus, final String sonsNo, final String nss, final CodeValueData filiation, final String phoneNo) {
        ...
        return new ClientData(accountNo, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id, firstname,
                ...
                clientLegalFormOptions,familyMemberOptions, legalForm,null,null, null, isStaff, curp, rfc, maritalStatus, sonsNo, nss, filiation, phoneNo);
    ...
    private ClientData(final String accountNo, final EnumOptionData status, final CodeValueData subStatus, final Long officeId,
            ...
            final Collection<StaffData> staffOptions, final Collection<CodeValueData> narrations,
            final Collection<CodeValueData> genderOptions, final Collection<CodeValueData> filiationOptions, final ClientTimelineData timeline,
            ...
            final String curp, final String rfc, final CodeValueData maritalStatus, final String sonsNo,
            final String nss, final CodeValueData filiation, final String phoneNo) {
        ...
        this.motherlastname = StringUtils.defaultIfEmpty(motherlastname, null);
        ...
        this.filiationOptions = filiationOptions;
