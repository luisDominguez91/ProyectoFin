...
public class DeleteClientAddressCommandHandler implements NewCommandSourceHandler {
	...
	public CommandProcessingResult processCommand(final JsonCommand command) {
		/*
		 * return
		 * this.writePlatformService.deleteClientAddress(command.getClientId(),
		 * command.entityId(), command.getStatus(), command);
		 */
		return this.writePlatformService.deleteClientAddress(command.getClientId(), command.entityId(), command);
