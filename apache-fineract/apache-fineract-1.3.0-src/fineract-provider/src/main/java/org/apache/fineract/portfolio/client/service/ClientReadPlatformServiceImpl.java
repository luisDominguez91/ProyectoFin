...
public class ClientReadPlatformServiceImpl implements ClientReadPlatformService {
    ...
    public ClientData retrieveTemplate(final Long officeId, final boolean staffInSelectedOfficeOnly) {
        ...
        // Se agraga lista de filiación{
        final List<CodeValueData> filiationOptions = new ArrayList<>(
                this.codeValueReadPlatformService.retrieveCodeValuesByCode(ClientApiConstants.FILIATION));
        // }
        return ClientData.template(defaultOfficeId, new LocalDate(), offices, staffOptions, null, genderOptions, filiationOptions, savingsProductDatas,
   ...
   // @Transactional(readOnly=true)
    ...
    private static final class ClientMembersOfGroupMapper implements RowMapper<ClientData> {
        ...
        public ClientMembersOfGroupMapper() {
            ...
            sqlBuilder.append("c.firstname as firstname, c.middlename as middlename, c.lastname as lastname, c.ctm_motherlastname as motherlastname, ");
            ...
            sqlBuilder.append("c.ctm_curp as curp, ");
            sqlBuilder.append("c.ctm_rfc as rfc, ");
            sqlBuilder.append("c.ctm_maritalstatus_id as maritalStatusId, ");
            sqlBuilder.append("cvMaritalStatus.code_value as maritalStatusValue, ");
            sqlBuilder.append("c.ctm_sons_no as sonsNo, ");
            sqlBuilder.append("c.ctm_nss as nss, ");
            sqlBuilder.append("c.ctm_filiation_id as filiationId, ");
            sqlBuilder.append("cvFiliation.code_value as filiationValue, ");
            sqlBuilder.append("c.ctm_phone_no as phoneNo, ");
            sqlBuilder.append("c.updated_on as updateOnDate, ");
            ...
            sqlBuilder.append("left join m_code_value cvMaritalStatus on cv.id = c.ctm_maritalstatus_id ");
            sqlBuilder.append("left join m_code_value cvFiliation on cv.id = c.ctm_filiation_id ");
        ...
        public ClientData mapRow(final ResultSet rs, final int rowNum) throws SQLException {
            ...
            final String sonsNo = rs.getString("sonsNo");
            final String nss = rs.getString("nss");
            final Long filiationId = JdbcSupport.getLong(rs, "filiationId");
            final String filiationValue = rs.getString("filiationValue");
            final CodeValueData filiation = CodeValueData.instance(filiationId, filiationValue);
            final String phoneNo = rs.getString("phoneNo");
            final LocalDate updateOnDate = JdbcSupport.getLocalDate(rs, "updateOnDate");
            // }
            ...
            final ClientTimelineData timeline = new ClientTimelineData(submittedOnDate, submittedByUsername, submittedByFirstname,
                    ...
                    closedByUsername, closedByFirstname, closedByLastname, updateOnDate);

            return ClientData.instance(accountNo, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id,
                    firstname, middlename, lastname, motherlastname, fullname, displayName, externalId, mobileNo, emailAddress, dateOfBirth, gender, activationDate,
                    imageId, staffId, staffName, timeline, savingsProductId, savingsProductName, savingsAccountId, clienttype,
                    classification, legalForm, clientNonPerson, isStaff, curp, rfc, maritalStatus, sonsNo, nss, filiation, phoneNo);
    ...
    private static final class ClientMapper implements RowMapper<ClientData> {
        ...
        public ClientMapper() {
            ...
            builder.append("c.firstname as firstname, c.middlename as middlename, c.lastname as lastname,c.ctm_motherlastname as motherlastname, ");
            ...
            // Se agregan los nuevos campos {
            builder.append("c.ctm_curp as curp, ");
            builder.append("c.ctm_rfc as rfc, ");
            builder.append("c.ctm_maritalstatus_id as maritalStatusId, ");
            builder.append("cvMaritalStatus.code_value as maritalStatusValue, ");
            builder.append("c.ctm_sons_no as sonsNo, ");
            builder.append("c.ctm_nss as nss, ");
            builder.append("c.ctm_filiation_id as filiationId, ");
            builder.append("cvFiliation.code_value as filiationValue, ");
            builder.append("c.ctm_phone_no as phoneNo, ");
            builder.append("c.updated_on as updateOnDate, ");
            ...
            builder.append("left join m_code_value cvMaritalStatus on cv.id = c.ctm_maritalstatus_id ");
            builder.append("left join m_code_value cvFiliation on cv.id = c.ctm_filiation_id ");
    ...
    private static final class ClientIdentifierMapper implements RowMapper<ClientData> {
        ...
        public String clientLookupByIdentifierSchema() {
            return "c.id as id, c.account_no as accountNo, c.firstname as firstname, c.middlename as middlename, c.lastname as lastname, c.motherlastname as motherlastname, "
        ...
        public ClientData mapRow(final ResultSet rs, final int rowNum) throws SQLException {
            ...
            return ClientData.clientIdentifier(id, accountNo, firstname, middlename, lastname , motherlastname, fullname, displayName, officeId, officeName);
        }
    }
